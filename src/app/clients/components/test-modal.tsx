                      ...
                      {!selectedClient ? (
                        <>
                          ...
                          <div className="space-y-2">
                              ...
                              <div className="flex items-center justify-between gap-3 rounded-lg border p-3 bg-accent">
                                  <div className="flex items-center gap-3">
                                      <User className="h-6 w-6 text-muted-foreground"/>
                                      <p className="text-lg font-semibold">{selectedClient.name}</p>
                                  </div>
                                  <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full" onClick={handleDeselectClient}>
                                      <X className="h-5 w-5" />
                                      <span className="sr-only">{t('selectAnotherClient')}</span>
                                  </Button>
                              </div>
                          </div>
                      )}
